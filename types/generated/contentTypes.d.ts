...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    CourseCurriculum: Schema.Attribute.Component<'week.curriculum', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Blocks;
    duration: Schema.Attribute.String;
    faqItems: Schema.Attribute.Component<'faq-items.faq-items', true>;
    image: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    KeyHighlights: Schema.Attribute.JSON;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    WhoCanJoin: Schema.Attribute.Component<'who-can-join.who-can-join', true>;
  };
}
